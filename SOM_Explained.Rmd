...
ProbOcc=function(x, psi=psi, p11=p11, p10=p10, K=K){
      ...
      #this equation directly from Lahoz-Monfort et al. 2016
```
...
[Note the `sink()` function here doesn't play well with `knitr`, and so you probably have to run these code chunks by hand to get them to run]
...
```{r}
mcmc_intervals(SOMmodel_0_10_detections, 
          regex_pars = "Occupancy_prob") +
